...
void cycle()
{
    ...
    printf("\n\t\tCycle entry is successful enter to system");
}
...
void bicycle()
{
    ...
    printf("\n\t\tBicycle entry is successful enter to system");
}
...
void risksha()
{
    ...
    printf("\n\t\tRisksha entry is successful enter to system");
}
...
void car()
{
    ...
    count++;
    total+=price_of_car;
    printf("\n\t\tCar entry is successful enter to system");
}
...
void bus()
{
    ...
    count++;
    total+=price_of_bus;
    printf("\n\t\tBus entry is successful enter to system");
}
void delete()
{
...
void showdetail()
{
    ...
    printf("\n\n********************************************************************************");
    printf("\n********************************************************************************");
    printf("\n\n\t\tStatus of Parking system till today is given below");
    ...
    printf("\n\n\tTotal Number vehicle  entry in System: %d",count);
